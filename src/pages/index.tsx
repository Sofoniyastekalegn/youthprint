...
export default function Home({ weblog, blogs, matchingBlogIndex, researchTags }: HomeProps) {
        ...
        <ResearchTagsProvider value={researchTags || []}>
            ...
            <div className="body-container">
                <div className='container-full '>
                    <div className='row'>
                        <div className="col-md-6 home-left fadeInLeft active">
    ...
    {weblog?.headervid?.data?.attributes.url ? (
        ...
        <p>No video available</p>
                ...
                <div className="body-container">
                    <div className="container-full pb-5 pt-5">
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <Link className="card h-100" href={`/publication/${matchingBlog?.attributes?.slug}`}>
